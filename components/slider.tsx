...
const Slider: React.FC<SliderProps> = ({
  ...
  const sliderItems = items.map((item, index) => {
    ...
    const isLastVisible =
      index === currentIndex + itemsPerPage - 1 || index === items.length - 1
    ...
    return (
      ...
      >
        <div
          ...
          onClick={e =>
            isClickable && handleItemClickWithSwipePrevention(item, e)
          }
          onKeyDown={e => {
    ...
    <>
      ...
      >
        <button
          ...
          onClick={handlePrev}
          disabled={
            (currentIndex === 0 && (!loop || !isMobileView)) || isAnimating
          }
        ...
        <button
          ...
          onClick={handleNext}
          disabled={
            (currentIndex === maxIndex && (!loop || !isMobileView)) ||
            isAnimating
          }
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                transformOrigin: `${50 + zoomPosition.x}% ${
                  50 + zoomPosition.y
                }%`,
                transition: isDragging
                  ? "none"
                  : "transform 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94), transform-origin 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
              }}
              onClick={handleImageClick}
              onMouseDown={handleMouseDown}
            >
              <img
                src={fullscreenImage.fullImageUrl || fullscreenImage.image}
